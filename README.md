Handler is a beta version program for checking the number of system handles, paged pool kilbytes, and threads are in use by a process.
...
known bugs: 
The Auto-refresh is not currently functioning.
